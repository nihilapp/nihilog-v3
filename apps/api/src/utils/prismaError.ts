...
export function prismaError(error: PrismaClientKnownRequestError) {
  if (!(error instanceof PrismaClientKnownRequestError)) {
    return prismaResponse(false, null, 'INTERNAL_SERVER_ERROR', MESSAGE.COMMON.ERROR);
  }

  switch (error.code) {
  // ===== Common Errors (P1XXX) =====
  case PRISMA_ERROR_CODE.P1000:
    return prismaResponse(false, null, 'INTERNAL_SERVER_ERROR', MESSAGE.DB.CONNECTION_ERROR);
  ...
  case PRISMA_ERROR_CODE.P1008:
    return prismaResponse(false, null, 'INTERNAL_SERVER_ERROR', MESSAGE.DB.QUERY_ERROR);
  case PRISMA_ERROR_CODE.P1009:
    return prismaResponse(false, null, 'CONFLICT', MESSAGE.COMMON.ALREADY_EXISTS);
  case PRISMA_ERROR_CODE.P1010:
    return prismaResponse(false, null, 'FORBIDDEN', MESSAGE.COMMON.PERMISSION_DENIED);
  ...
  case PRISMA_ERROR_CODE.P1014:
    return prismaResponse(false, null, 'NOT_FOUND', MESSAGE.COMMON.NOT_FOUND);
  ...
  case PRISMA_ERROR_CODE.P2034:
    return prismaResponse(false, null, 'CONFLICT', MESSAGE.DB.QUERY_ERROR);
