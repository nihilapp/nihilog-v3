...
export const registerAllSchemas = () => {
  ...
  openApiRegistry.register('Password', passwordSchema);
  openApiRegistry.register('UserInfo', userInfoSchema);
  openApiRegistry.register('CreateUser', createUserSchema);
  openApiRegistry.register('UpdateUser', updateUserSchema);
  openApiRegistry.register('SignIn', signInSchema);
  openApiRegistry.register('ForgotPassword', forgotPasswordSchema);
  openApiRegistry.register('ChangePassword', changePasswordSchema);
  openApiRegistry.register('ResetPassword', resetPasswordSchema);
  openApiRegistry.register('Withdraw', withdrawSchema);
  openApiRegistry.register('SearchUser', searchUserSchema);
  ...
  // 구독 관련 스키마 등록
  openApiRegistry.register('UserSubscribe', userSubscribeSchema);
  openApiRegistry.register('CreateSubscribe', createSubscribeSchema);
  openApiRegistry.register('UpdateSubscribe', updateSubscribeSchema);
  openApiRegistry.register('DefaultSubscribe', defaultSubscribeSchema);
  openApiRegistry.register('PartialSubscribe', partialSubscribeSchema);

  // 카테고리 구독 관련 스키마 등록
  openApiRegistry.register('CategorySubscribe', categorySubscribeSchema);
  openApiRegistry.register('CategorySubscribeItemList', categorySubscribeItemListSchema);
  openApiRegistry.register('CreateCategorySubscribe', createCategorySubscribeSchema);
  openApiRegistry.register('UpdateCategorySubscribe', updateCategorySubscribeSchema);
  openApiRegistry.register('DeleteCategorySubscribe', deleteCategorySubscribeSchema);
  openApiRegistry.register('SearchCategorySubscribe', searchCategorySubscribeSchema);

  // 태그 구독 관련 스키마 등록
  openApiRegistry.register('TagSubscribe', tagSubscribeSchema);
  openApiRegistry.register('TagSubscribeItemList', tagSubscribeItemListSchema);
  openApiRegistry.register('CreateTagSubscribe', createTagSubscribeSchema);
  openApiRegistry.register('UpdateTagSubscribe', updateTagSubscribeSchema);
  openApiRegistry.register('DeleteTagSubscribe', deleteTagSubscribeSchema);
  openApiRegistry.register('SearchTagSubscribe', searchTagSubscribeSchema);

  // 로그 관련 스키마 등록
  openApiRegistry.register('PostViewLog', postViewLogSchema);
  openApiRegistry.register('PostShareLog', postShareLogSchema);
  openApiRegistry.register('CreatePostShareLog', createPostShareLogSchema);

  // 태그 관련 스키마 등록
  openApiRegistry.register('TagInfo', tagInfoSchema);
  openApiRegistry.register('CreateTag', createTagSchema);
  openApiRegistry.register('UpdateTag', updateTagSchema);
  openApiRegistry.register('SearchTag', searchTagSchema);
  openApiRegistry.register('DeleteTag', deleteTagSchema);
  openApiRegistry.register('PstTagMpng', pstTagMpngSchema);
  openApiRegistry.register('CreatePstTagMpng', createPstTagMpngSchema);
