          ...
          'application/json': {
            ...
            examples: addGlobalResponses({
              success: {
                ...
                value: createResponse('SUCCESS', MESSAGE.SUBSCRIBE.TAG.ADMIN_MULTIPLE_CREATE_SUCCESS, {
                  successCnt: 3,
                  failCnt: 0,
                  failNoList: [],
                }),
              ...
              conflict: {
                ...
                value: createError('CONFLICT', MESSAGE.SUBSCRIBE.TAG.ALREADY_EXISTS),
              },
              error: {
                summary: '다수 태그 구독 생성 실패',
                value: createError('INTERNAL_SERVER_ERROR', MESSAGE.SUBSCRIBE.TAG.ADMIN_MULTIPLE_CREATE_ERROR),
              },
            }, {
          ...
          'application/json': {
            ...
            examples: addGlobalResponses({
              success: {
                ...
                value: createResponse('SUCCESS', MESSAGE.SUBSCRIBE.TAG.ADMIN_MULTIPLE_UPDATE_SUCCESS, {
                  successCnt: 3,
                  failCnt: 0,
                  failNoList: [],
                }),
              ...
              notFound: {
                ...
                value: createError('NOT_FOUND', MESSAGE.SUBSCRIBE.TAG.NOT_FOUND),
              },
              error: {
                summary: '다수 태그 구독 수정 실패',
                value: createError('INTERNAL_SERVER_ERROR', MESSAGE.SUBSCRIBE.TAG.ADMIN_MULTIPLE_UPDATE_ERROR),
              },
            }, {
              hasAuthGuard: true, // JWT 인증 사용
              hasRoles: true, // 권한 사용
          ...
          'application/json': {
            ...
            examples: addGlobalResponses({
              success: {
                ...
                value: createResponse('SUCCESS', MESSAGE.SUBSCRIBE.TAG.ADMIN_MULTIPLE_DELETE_SUCCESS, {
                  successCnt: 3,
                  failCnt: 0,
                  failNoList: [],
                }),
              ...
              error: {
                ...
                value: createError('INTERNAL_SERVER_ERROR', MESSAGE.SUBSCRIBE.TAG.ADMIN_MULTIPLE_DELETE_ERROR),
              },
            }, {
              hasAuthGuard: true, // JWT 인증 사용
              hasRoles: true, // 권한 사용
