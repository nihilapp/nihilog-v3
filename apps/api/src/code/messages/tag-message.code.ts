...
export const TAG_MESSAGES = {
  ...
  ADMIN: {
    ...
    // 태그 통계 관련
    TOP_USED_SUCCESS: '태그 사용 횟수 TOP N 조회 성공',
    TOP_USED_ERROR: '태그 사용 횟수 TOP N 조회 실패',
    USAGE_TREND_SUCCESS: '태그 사용 추이 조회 성공',
    USAGE_TREND_ERROR: '태그 사용 추이 조회 실패',
    UNUSED_SUCCESS: '미사용 태그 목록 조회 성공',
    UNUSED_ERROR: '미사용 태그 목록 조회 실패',
    TOP_SUBSCRIBERS_SUCCESS: '태그별 구독자 수 TOP N 조회 성공',
    TOP_SUBSCRIBERS_ERROR: '태그별 구독자 수 TOP N 조회 실패',
    SUBSCRIBER_GROWTH_SUCCESS: '태그별 구독자 성장률 조회 성공',
    SUBSCRIBER_GROWTH_ERROR: '태그별 구독자 성장률 조회 실패',
    NO_SUBSCRIBERS_SUCCESS: '구독자 없는 태그 목록 조회 성공',
    NO_SUBSCRIBERS_ERROR: '구독자 없는 태그 목록 조회 실패',
    EFFICIENCY_SUCCESS: '태그별 사용 효율성 조회 성공',
    EFFICIENCY_ERROR: '태그별 사용 효율성 조회 실패',
    FREQUENCY_SUCCESS: '태그별 평균 사용 빈도 조회 성공',
    FREQUENCY_ERROR: '태그별 평균 사용 빈도 조회 실패',
    LIFECYCLE_SUCCESS: '태그 생명주기 분석 조회 성공',
    LIFECYCLE_ERROR: '태그 생명주기 분석 조회 실패',
    STATUS_DISTRIBUTION_SUCCESS: '태그 상태별 분포 조회 성공',
    STATUS_DISTRIBUTION_ERROR: '태그 상태별 분포 조회 실패',
    CREATOR_STATS_SUCCESS: '태그 생성자별 통계 조회 성공',
    CREATOR_STATS_ERROR: '태그 생성자별 통계 조회 실패',
    CLEANUP_SUCCESS: '태그 정리 필요도 조회 성공',
    CLEANUP_ERROR: '태그 정리 필요도 조회 실패',
  },
} as const;
