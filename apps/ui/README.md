...
Next.js 16와 최신 기술 스택을 활용한 완전한 웹 애플리케이션 템플릿입니다. 사용자 인증, 프로필 관리, 관리자 기능이 포함된 실용적인 출발점을 제공합니다.

## ✨ 주요 특징

- 🚀 **Next.js 16** - App Router와 React 19 기반
...
├── public/                 # 정적 파일
└── proxy.ts                # Next.js 프록시 (Next.js 16)
```
