...
interface UseMultipleDeleteTagSubscribeOptions extends MutationOptionsType<MultipleResultType, DeleteTagSubscribeType> {}

/**
 * @description 다수 태그 구독을 일괄 해제하는 커스텀 훅
 * @param {UseMultipleDeleteTagSubscribeOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useMultipleDeleteTagSubscribe(options: UseMultipleDeleteTagSubscribeOptions = {}) {
