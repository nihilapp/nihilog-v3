...
interface UseMultipleDeleteCommentOptions
  extends MutationOptionsType<MultipleResultType, DeleteCommentType> {}

/**
 * @description 관리자 댓글 일괄 삭제하는 커스텀 훅
 * @param {UseMultipleDeleteCommentOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useMultipleDeleteComment(options: UseMultipleDeleteCommentOptions = {}) {
