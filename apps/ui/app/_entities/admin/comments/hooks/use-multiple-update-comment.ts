...
interface UseMultipleUpdateCommentOptions
  extends MutationOptionsType<MultipleResultType, UpdateCommentType> {}

/**
 * @description 관리자 댓글 일괄 수정하는 커스텀 훅
 * @param {UseMultipleUpdateCommentOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useMultipleUpdateComment(options: UseMultipleUpdateCommentOptions = {}) {
