...
interface UseMultipleDeleteUserSubscribeOptions extends MutationOptionsType<MultipleResultType, DeleteSubscribeType> {}

/**
 * @description 다수 사용자 구독 설정을 일괄 삭제하는 커스텀 훅
 * @param {UseMultipleDeleteUserSubscribeOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useMultipleDeleteUserSubscribe(options: UseMultipleDeleteUserSubscribeOptions = {}) {
