...
interface UseMultipleUpdateUserSubscribeOptions extends MutationOptionsType<any, UpdateSubscribeType> {}

/**
 * @description 다수 사용자 구독 설정을 일괄 변경하는 커스텀 훅
 * @param {UseMultipleUpdateUserSubscribeOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useMultipleUpdateUserSubscribe(options: UseMultipleUpdateUserSubscribeOptions = {}) {
