...
interface UseCreateUserSubscribeOptions extends MutationOptionsType<UserSubscribeInfoType, CreateSubscribeType> {}

/**
 * @description 관리자가 특정 사용자 구독 설정을 생성하는 커스텀 훅
 * @param {UseCreateUserSubscribeOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useCreateUserSubscribe(options: UseCreateUserSubscribeOptions = {}) {
