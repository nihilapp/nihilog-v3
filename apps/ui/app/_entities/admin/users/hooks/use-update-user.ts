...
interface UseUpdateUserOptions extends MutationOptionsType<SelectUserInfoType, UpdateUserType> {
  userNo: number;
}

/**
 * @description 사용자를 수정하는 커스텀 훅
 * @param {UseUpdateUserOptions} [options] - 뮤테이션 옵션 (선택사항)
 */
export function useUpdateUser(options: UseUpdateUserOptions = { userNo: 0, }) {
