...
interface UseAdminAnalyzeAverageViewsOptions extends MutationOptionsType<AverageViewStatItemType[], AnalyzeStatType> {}

export function useAdminAnalyzeAverageViews(options: UseAdminAnalyzeAverageViewsOptions = {}) {
  const query = usePost<AverageViewStatItemType[], AnalyzeStatType>({
    url: [
