...
export function CategoryParentSelect({ categoryList, value, onChange, excludeCategoryNo, }: Props) {
  ...
  const level1Children = useMemo(
    () => {
      ...
      return getChildren(selectedLevel0);
    },
    [
      selectedLevel0,
      getChildren,
  ...
  const level2Children = useMemo(
    () => {
      ...
      return getChildren(selectedLevel1);
    },
    [
      selectedLevel1,
      getChildren,
  ...
  const level3Children = useMemo(
    () => {
      ...
      return getChildren(selectedLevel2);
    },
    [
      selectedLevel2,
      getChildren,
